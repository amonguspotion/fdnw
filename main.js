...
document.getElementById("target_sketch").innerHTML = 'Sketch to be drawn - ' + sketch;
...
function gotresult(error, results){
    if(error){
        ...
        document.getElementById("player_sketch").innerHTML = "Your Sketch : " + drawn_sketch;
        document.getElementById("sketch_confidence").innerHTML = "Confidence : " + Math.floor(results[0].confidence*100) + "%";
    }
}
